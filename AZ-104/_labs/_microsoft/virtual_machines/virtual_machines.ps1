...
#>
Connect-AzAccount
New-AzVM -ResourceGroupName "rg_eastus_77623_1_16663081281688" -Name "az104vmpjh" -Location "EastUS" -Size "Standard_B2s" -VirtualNetworkName "myVMVMNic" -SubnetName "default"-SecurityGroupName "newpjhNSG" -PublicIpAddressName "az104pjhIPAddress" -OpenPorts 80,443,3389
New-AzVM -ResourceGroupName "rg_eastus_77623_1_16663081281688" -Name "az104vmpjh2" -Location "EastUS" -Size "Standard_B2s" -VirtualNetworkName "myVMVMNic2" -SubnetName "default"-SecurityGroupName "newpjhNSG2" -PublicIpAddressName "az104pjhIPAddress2" -OpenPorts 80,443,3389
